...
/** Doelgrootte van een bord. */
export const IDEALE_SPELERS_PER_BORD = 4;
/** Automatisch verdelen zet nooit meer dan 5 spelers op een bord. */
...
/** 6 borden × 5 spelers: hierboven past de normale verdeling niet meer. */
export const COMFORTABEL_MAX_SPELERS = MAX_BORDEN * MAX_AUTOMATISCH_PER_BORD;
...
/**
 * Bepaalt de bordverdeling. Er worden zoveel borden geopend als nodig is om
 * onder de 4 spelers per bord te blijven: ceil(spelers / 4), met 6 borden als
 * maximum. Pas als 6 borden vol zijn komt er een 5e speler op een bord.
 */
export function berekenBordVerdeling(aantalSpelers: number): number[] | null {
  ...
  // Noodverdeling boven 6 borden × 5 spelers: grotere borden toestaan.
